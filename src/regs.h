...
#define DALI_STATUS_HR_BASE (BINDINGS_HR_BASE + MAX_DISCRETE_INPUTS)
#define DALI_MINMAX_HR_BASE (DALI_STATUS_HR_BASE + MAX_DALI_LIGHTS)
#define DALI_FADE_HR_BASE (DALI_MINMAX_HR_BASE + MAX_DALI_LIGHTS)
#define DALI_POWERON_HR_BASE (DALI_FADE_HR_BASE + MAX_DALI_LIGHTS)
#define DALI_GROUPS_HR_BASE (DALI_POWERON_HR_BASE + MAX_DALI_LIGHTS)
